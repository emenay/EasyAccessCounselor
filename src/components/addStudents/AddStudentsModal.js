...
class AddStudentsModal extends React.Component {
  constructor(props) {
    ...
    this.state = {
      view: (
        <AddStudentManual
          closeAddStudent={this.props.closeAddStudent}
          ...
          <div className="tabs is-centered" id="tabs">
            <ul id="navigation">
              <li
                ...
                <a id="add_manually" className="navbar-item tab">
                  Add Manually
                </a>
              </li>
              <li className="btn" id="import" onClick={this.changeView}>
                <a id="import_spreadsheet" className="navbar-item tab">
                  Import Spreadsheet
                </a>
              </li>
            </ul>
          </div>
          <div className="add-students-view">{this.state.view}</div>
        </div>
      </div>
    )
  }
